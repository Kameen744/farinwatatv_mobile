...
import 'package:farinwatatv/util/coming_soon_page_json.dart';
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(15), color: lightBlack),
                child: Padding(
                  padding:
                      const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                  child: Row(
                    ...
                    Positioned(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              additionVideos[index]['name'],
                              style: TextStyle(color: lightGrey, fontSize: 11),
                            ),
                            Text(
                              additionVideos[index]['time'],
                              style: TextStyle(color: grey, fontSize: 9),
                            )
                          ],
                        ),
